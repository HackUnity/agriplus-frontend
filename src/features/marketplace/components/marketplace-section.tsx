...
export function MarketplaceSection() {
  ...
  return (
    <section
      id="marketplace"
      className="scroll-mt-20 bg-mint-gradient py-16"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-warning-foreground/80">
            Live auctions
          </p>
          <h2 className="mt-2 font-serif text-3xl font-bold tracking-tight text-primary-strong sm:text-4xl">
        ...
        <div className="mb-8 flex flex-col gap-4 lg:flex-row">
          ...
          <select
            className="h-11 rounded-md border border-input bg-card px-3 py-2 text-sm shadow-xs"
            value={sort}
